    ...
    Surface(
        ...
        Column(
            ...
            Row(
                ...
                Text("STR ${fmt(derived.strMod)}")
                Text("DEX ${fmt(derived.dexMod)}")
                Text("CON ${fmt(derived.conMod)}")
            }
            ...
            Row(
                ...
                Text("INT ${fmt(derived.intMod)}")
                Text("WIS ${fmt(derived.wisMod)}")
                Text("CHA ${fmt(derived.chaMod)}")
            }
